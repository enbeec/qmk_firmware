...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [QWERTY] = LAYOUT_ortho_5x15(
            ...
            TT(FN_LAY), KC_LCTL, KC_LGUI, KC_LALT, LT(_LOWER, KC_BSPC),LT(FN_LAY, KC_SPC),XXXXXXX,LT(_RAISE, KC_ENT), KC_RALT, KC_RGUI, KC_RCTL, XXXXXXX,_______,TT(GAMERR),TT(PLANCK)
   ),
 [PLANCK] = LAYOUT_ortho_5x15(
            ...
            LT(ADJUST, KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_ENT, XXXXXXX,XXXXXXX,XXXXXXX,
            KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM,KC_DOT, KC_SLASH, KC_RSFT,XXXXXXX,XXXXXXX,XXXXXXX,
            TT(FN_LAY), KC_LCTL, KC_LGUI, KC_LALT, LT(_LOWER, KC_BSPC),LT(FN_LAY, KC_SPC),XXXXXXX,LT(_RAISE, KC_ENT), KC_RALT, KC_RGUI, KC_RCTL, XXXXXXX,_______,_______,_______
   ),
 ...
 [GAMERR] = LAYOUT_ortho_5x15(
            ...
            KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC,KC_RBRC,KC_BSPACE,_______,
            LT(ADJUST, KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_ENT ,_______,_______,_______,
            KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM,KC_DOT, KC_SLASH, KC_RSFT,_______,_______,_______,
            TT(FN_LAY), KC_LCTL, KC_LGUI, KC_LALT, KC_SPACE,KC_SPACE,KC_SPACE,KC_SPACE, KC_RALT, KC_RGUI, KC_RCTL, _______,_______,_______,_______
   ),
